...
# Never persisted; capped per owner and cleared when the process exits.
_OWNER_REQUEST_HISTORY: dict[str, list[dict[str, Any]]] = {}
_OWNER_TURN_IDS: dict[str, str] = {}
# Volatile owner-context expansion state for LLM verifier calls. Active records apply
# only within their recorded owner turn; queued records are promoted on the next
# owner turn, then replaced/cleared at the following turn boundary.
_OWNER_CONTEXT_ACTIVE_EXPANSIONS: dict[str, dict[str, Any]] = {}
_OWNER_CONTEXT_QUEUED_EXPANSIONS: dict[str, dict[str, Any]] = {}
